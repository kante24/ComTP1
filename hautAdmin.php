        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target=_blank href="AccueilAdmin.php">Accueil</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target=_blank href="adminAnnonce.php">Administration des Annonces</a>
                    </li>



                    <li class="nav-item">
                        <a class="nav-link" target=_blank href="adminUtilisateur.php">Administration des Utilisateurs</a>
                    </li>
